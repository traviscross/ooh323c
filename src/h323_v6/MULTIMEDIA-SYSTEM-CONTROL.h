...
/**
 * Header file for ASN.1 module MULTIMEDIA-SYSTEM-CONTROL
 */
/**************************************************************/
/*                                                            */
...
typedef struct EXTERN H245NonStandardIdentifier_h221NonStandard {
   OOUINT8 t35CountryCode;
   OOUINT8 t35Extension;
   OOUINT16 manufacturerCode;
...
typedef struct EXTERN H245V42bis {
   OOUINT32 numberOfCodewords;
   OOUINT16 maximumStringLength;
} H245V42bis;
...
typedef struct EXTERN H245T38FaxUdpOptions {
   ...
   OOINT32 t38FaxMaxBuffer;
   OOINT32 t38FaxMaxDatagram;
...
typedef struct EXTERN H245T38FaxTcpOptions {
   OOBOOL t38TCPBidirectionalMode;
...
typedef struct EXTERN H245T38FaxProfile {
   ...
   OOBOOL fillBitRemoval;
   OOBOOL transcodingJBIG;
   OOBOOL transcodingMMR;
   OOUINT8 version;
...
typedef struct EXTERN H245GenericTransportParameters {
   struct {
      unsigned nonStandardDataPresent : 1;
      unsigned averageRatePresent : 1;
      unsigned burstPresent : 1;
      unsigned peakRatePresent : 1;
      unsigned maxPktSizePresent : 1;
   } m;
   H245NonStandardParameter nonStandardData;
   OOUINT32 averageRate;
   OOUINT32 burst;
   OOUINT32 peakRate;
   OOUINT32 maxPktSize;
} H245GenericTransportParameters;
...
typedef struct EXTERN H245ServicePriorityValue {
   struct {
      unsigned nonStandardParameterPresent : 1;
   } m;
   H245NonStandardParameter nonStandardParameter;
} H245ServicePriorityValue;
...
typedef struct EXTERN H245ServicePriority {
   struct {
      unsigned nonStandardDataPresent : 1;
      unsigned servicePriorityValuePresent : 1;
   } m;
   H245NonStandardParameter nonStandardData;
   OOBOOL servicePrioritySignalled;
   H245ServicePriorityValue servicePriorityValue;
} H245ServicePriority;
...
typedef struct EXTERN H245AuthorizationParameters {
   struct {
      unsigned nonStandardDataPresent : 1;
   } m;
   H245NonStandardParameter nonStandardData;
} H245AuthorizationParameters;
...
#define T_H245QOSType_desired           1
#define T_H245QOSType_required          2
#define T_H245QOSType_extElem1          3

typedef struct EXTERN H245QOSType {
   int t;
} H245QOSType;
...
#define T_H245QOSClass_class0           1
#define T_H245QOSClass_class1           2
#define T_H245QOSClass_class2           3
#define T_H245QOSClass_class3           4
#define T_H245QOSClass_class4           5
#define T_H245QOSClass_class5           6
#define T_H245QOSClass_extElem1         7

typedef struct EXTERN H245QOSClass {
   int t;
} H245QOSClass;
...
typedef struct EXTERN H245QOSDescriptor {
   struct {
      unsigned nonStandardDataPresent : 1;
   } m;
   H245NonStandardParameter nonStandardData;
...
typedef struct EXTERN H245QOSCapability {
   struct {
      ...
      unsigned localQoSPresent : 1;
      unsigned genericTransportParametersPresent : 1;
      unsigned servicePriorityPresent : 1;
      unsigned authorizationParameterPresent : 1;
      unsigned qosDescriptorPresent : 1;
      unsigned dscpValuePresent : 1;
   } m;
   H245NonStandardParameter nonStandardData;
   ...
   H245QOSDescriptor qosDescriptor;
   OOUINT8 dscpValue;
} H245QOSCapability;
...
typedef OOUINT8 H245SequenceNumber;
...
typedef struct EXTERN H245ParameterValue {
   ...
   union {
      /* t = 1 */
      /* t = 2 */
      OOUINT8 booleanArray;
      /* t = 3 */
      OOUINT16 unsignedMin;
      /* t = 4 */
      OOUINT16 unsignedMax;
      /* t = 5 */
      OOUINT32 unsigned32Min;
      /* t = 6 */
      OOUINT32 unsigned32Max;
      /* t = 7 */
...
typedef struct EXTERN H245GenericMessage {
   struct {
      unsigned subMessageIdentifierPresent : 1;
      unsigned messageContentPresent : 1;
   } m;
   H245CapabilityIdentifier messageIdentifier;
   OOUINT8 subMessageIdentifier;
   H245_SeqOfH245GenericParameter messageContent;
} H245GenericMessage;
...
typedef H245GenericMessage H245GenericInformation;
...
typedef OOUINT16 H245CapabilityTableEntryNumber;
...
typedef OOUINT8 H245CapabilityDescriptorNumber;
...
typedef OOUINT32 H245MaxRedundancy;
...
typedef OOUINT16 H245LogicalChannelNumber;
...
typedef OOUINT8 H245MultiplexTableEntryNumber;
...
typedef OOUINT8 H245TerminalNumber;
...
typedef OOUINT32 H245MaximumBitRate;
...
typedef struct EXTERN H245IV16 {
   OOUINT32 numocts;
   ASN1OCTET data[16];
} H245IV16;
...
typedef struct H245EscrowData_escrowValue {
   OOUINT32 numbits;
   ASN1OCTET  data[8192];
...
typedef struct EXTERN H245UserInputIndication_signal_encryptedSignalType {
   OOUINT32 numocts;
   ASN1OCTET data[1];
} H245UserInputIndication_signal_encryptedSignalType;
...
typedef struct EXTERN H245MasterSlaveDetermination {
   OOUINT8 terminalType;
   OOUINT32 statusDeterminationNumber;
...
typedef struct EXTERN H245VCCapability_aal1 {
   OOBOOL nullClockRecovery;
   OOBOOL srtsClockRecovery;
   OOBOOL adaptiveClockRecovery;
   OOBOOL nullErrorCorrection;
   OOBOOL longInterleaver;
   OOBOOL shortInterleaver;
   OOBOOL errorCorrectionOnly;
   OOBOOL structuredDataTransfer;
   OOBOOL partiallyFilledCells;
...
typedef struct EXTERN H245VCCapability_aal5 {
   OOUINT16 forwardMaximumSDUSize;
   OOUINT16 backwardMaximumSDUSize;
...
typedef struct EXTERN H245VCCapability_availableBitRates_type_rangeOfBitRates {
   OOUINT16 lowerBitRate;
   OOUINT16 higherBitRate;
...
typedef struct EXTERN H245Q2931Address_address {
   ...
   union {
      /* t = 1 */
      const char* internationalNumber;
      /* t = 2 */
...
typedef struct EXTERN H245VCCapability {
   ...
   OOBOOL transportStream;
   OOBOOL programStream;
...
typedef struct EXTERN H245H223Capability_h223MultiplexTableCapability_enhanced {
   OOUINT8 maximumNestingDepth;
   OOUINT8 maximumElementListSize;
   OOUINT8 maximumSubElementListSize;
...
typedef struct EXTERN H245H223Capability_mobileOperationTransmitCapability {
   OOBOOL modeChangeCapability;
   OOBOOL h223AnnexA;
   OOBOOL h223AnnexADoubleFlag;
   OOBOOL h223AnnexB;
   OOBOOL h223AnnexBwithHeader;
...
typedef struct EXTERN H245H223AnnexCCapability {
   ...
   OOBOOL videoWithAL1M;
   OOBOOL videoWithAL2M;
   OOBOOL videoWithAL3M;
   OOBOOL audioWithAL1M;
   OOBOOL audioWithAL2M;
   OOBOOL audioWithAL3M;
   OOBOOL dataWithAL1M;
   OOBOOL dataWithAL2M;
   OOBOOL dataWithAL3M;
   OOBOOL alpduInterleaving;
   OOUINT16 maximumAL1MPDUSize;
   OOUINT16 maximumAL2MSDUSize;
   OOUINT16 maximumAL3MSDUSize;
   OOBOOL rsCodeCapability;
...
typedef struct EXTERN H245H223Capability_mobileMultilinkFrameCapability {
   OOUINT8 maximumSampleSize;
   OOUINT16 maximumPayloadLength;
...
typedef struct EXTERN H245H223Capability {
   ...
   OOBOOL dataWithAL2;
   OOBOOL dataWithAL3;
   OOUINT16 maximumAl2SDUSize;
   OOUINT16 maximumAl3SDUSize;
   OOUINT16 maximumDelayJitter;
   H245H223Capability_h223MultiplexTableCapability h223MultiplexTableCapability;
   OOBOOL maxMUXPDUSizeCapability;
   OOBOOL nsrpSupport;
...
typedef struct EXTERN H245V76Capability {
   OOBOOL suspendResumeCapabilitywAddress;
   OOBOOL suspendResumeCapabilitywoAddress;
   OOBOOL rejCapability;
   OOBOOL sREJCapability;
   OOBOOL mREJCapability;
   OOBOOL crc8bitCapability;
   OOBOOL crc16bitCapability;
   OOBOOL crc32bitCapability;
   OOBOOL uihCapability;
   OOUINT16 numOfDLCS;
   OOBOOL twoOctetAddressFieldCapability;
   OOBOOL loopBackTestCapability;
   OOUINT16 n401Capability;
   OOUINT8 maxWindowSizeCapability;
...
typedef struct EXTERN H245T84Profile_t84Restricted {
   ...
   OOBOOL hdtvSeq;
   OOBOOL hdtvProg;
   OOBOOL g3FacsMH200x100;
   OOBOOL g3FacsMH200x200;
   OOBOOL g4FacsMMR200x100;
   OOBOOL g4FacsMMR200x200;
   OOBOOL jbig200x200Seq;
   OOBOOL jbig200x200Prog;
   OOBOOL jbig300x300Seq;
   OOBOOL jbig300x300Prog;
   OOBOOL digPhotoLow;
   OOBOOL digPhotoMedSeq;
   OOBOOL digPhotoMedProg;
   OOBOOL digPhotoHighSeq;
   OOBOOL digPhotoHighProg;
...
typedef struct EXTERN H245MediaDistributionCapability {
   ...
   OOBOOL centralizedControl;
   OOBOOL distributedControl;
   OOBOOL centralizedAudio;
   OOBOOL distributedAudio;
   OOBOOL centralizedVideo;
   OOBOOL distributedVideo;
...
typedef struct EXTERN H245MultipointCapability {
   OOBOOL multicastCapability;
   OOBOOL multiUniCastConference;
...
typedef struct EXTERN H245H2250Capability_mcCapability {
   OOBOOL centralizedConferenceMC;
   OOBOOL decentralizedConferenceMC;
...
typedef struct EXTERN H245MediaPacketizationCapability {
   ...
   OOBOOL h261aVideoPacketization;
...
typedef struct EXTERN H245RTPH263VideoRedundancyEncoding {
   ...
   OOUINT8 numberOfThreads;
   OOUINT16 framesBetweenSyncPoints;
...
typedef struct EXTERN H245H2250Capability {
   ...
   OOUINT16 maximumAudioDelayJitter;
   ...
   OOBOOL rtcpVideoControlCapability;
   ...
   OOBOOL logicalChannelSwitchingCapability;
   OOBOOL t120DynamicPortCapability;
} H245H2250Capability;
...
typedef struct EXTERN H245H261VideoCapability {
   ...
   OOUINT8 qcifMPI;
   OOUINT8 cifMPI;
   OOBOOL temporalSpatialTradeOffCapability;
   OOUINT16 maxBitRate;
   OOBOOL stillImageTransmission;
   OOBOOL videoBadMBsCap;
...
typedef struct EXTERN H245H262VideoCapability {
   ...
   OOBOOL profileAndLevel_SPatML;
   OOBOOL profileAndLevel_MPatLL;
   OOBOOL profileAndLevel_MPatML;
   OOBOOL profileAndLevel_MPatH_14;
   OOBOOL profileAndLevel_MPatHL;
   OOBOOL profileAndLevel_SNRatLL;
   OOBOOL profileAndLevel_SNRatML;
   OOBOOL profileAndLevel_SpatialatH_14;
   OOBOOL profileAndLevel_HPatML;
   OOBOOL profileAndLevel_HPatH_14;
   OOBOOL profileAndLevel_HPatHL;
   OOUINT32 videoBitRate;
   OOUINT32 vbvBufferSize;
   OOUINT16 samplesPerLine;
   OOUINT16 linesPerFrame;
   OOUINT8 framesPerSecond;
   OOUINT32 luminanceSampleRate;
   OOBOOL videoBadMBsCap;
...
typedef struct EXTERN H245RefPictureSelection_additionalPictureMemory {
   ...
   OOUINT16 sqcifAdditionalPictureMemory;
   OOUINT16 qcifAdditionalPictureMemory;
   OOUINT16 cifAdditionalPictureMemory;
   OOUINT16 cif4AdditionalPictureMemory;
   OOUINT16 cif16AdditionalPictureMemory;
   OOUINT16 bigCpfAdditionalPictureMemory;
...
typedef struct EXTERN H245CustomPictureClockFrequency {
   ...
   OOUINT16 clockConversionCode;
   OOUINT8 clockDivisor;
   OOUINT16 sqcifMPI;
   OOUINT16 qcifMPI;
   OOUINT16 cifMPI;
   OOUINT16 cif4MPI;
...
typedef struct EXTERN H245CustomPictureFormat {
   OOUINT16 maxCustomPictureWidth;
   OOUINT16 maxCustomPictureHeight;
   OOUINT16 minCustomPictureWidth;
   OOUINT16 minCustomPictureHeight;
...
typedef struct EXTERN H245H263Version3Options {
   OOBOOL dataPartitionedSlices;
   OOBOOL fixedPointIDCT0;
   OOBOOL interlacedFields;
   OOBOOL currentPictureHeaderRepetition;
   OOBOOL previousPictureHeaderRepetition;
   OOBOOL nextPictureHeaderRepetition;
   OOBOOL pictureNumber;
   OOBOOL spareReferencePictures;
...
typedef struct EXTERN H245H263ModeComboFlags {
   ...
   OOBOOL unrestrictedVector;
   OOBOOL arithmeticCoding;
   OOBOOL advancedPrediction;
   OOBOOL pbFrames;
   OOBOOL advancedIntraCodingMode;
   OOBOOL deblockingFilterMode;
   OOBOOL unlimitedMotionVectors;
   OOBOOL slicesInOrder_NonRect;
   OOBOOL slicesInOrder_Rect;
   OOBOOL slicesNoOrder_NonRect;
   OOBOOL slicesNoOrder_Rect;
   OOBOOL improvedPBFramesMode;
   OOBOOL referencePicSelect;
   OOBOOL dynamicPictureResizingByFour;
   OOBOOL dynamicPictureResizingSixteenthPel;
   OOBOOL dynamicWarpingHalfPel;
   OOBOOL dynamicWarpingSixteenthPel;
   OOBOOL reducedResolutionUpdate;
   OOBOOL independentSegmentDecoding;
   OOBOOL alternateInterVLCMode;
   OOBOOL modifiedQuantizationMode;
   OOBOOL enhancedReferencePicSelect;
...
typedef struct EXTERN H245H263Options {
   ...
   OOBOOL improvedPBFramesMode;
   OOBOOL unlimitedMotionVectors;
   OOBOOL fullPictureFreeze;
   OOBOOL partialPictureFreezeAndRelease;
   OOBOOL resizingPartPicFreezeAndRelease;
   OOBOOL fullPictureSnapshot;
   OOBOOL partialPictureSnapshot;
   OOBOOL videoSegmentTagging;
   OOBOOL progressiveRefinement;
   OOBOOL dynamicPictureResizingByFour;
   OOBOOL dynamicPictureResizingSixteenthPel;
   OOBOOL dynamicWarpingHalfPel;
   OOBOOL dynamicWarpingSixteenthPel;
   ...
   OOBOOL separateVideoBackChannel;
...
typedef struct EXTERN H245EnhancementOptions {
   ...
   OOBOOL arithmeticCoding;
   OOBOOL temporalSpatialTradeOffCapability;
   OOUINT16 slowSqcifMPI;
   OOUINT16 slowQcifMPI;
   OOUINT16 slowCifMPI;
   OOUINT16 slowCif4MPI;
   OOUINT16 slowCif16MPI;
   OOBOOL errorCompensation;
...
/**************************************************************/
/*                                                            */
/*  _SeqOfH245VideoCapability                                 */
/*                                                            */
/**************************************************************/

struct EXTERN H245VideoCapability;

/* List of H245VideoCapability */
typedef DList H245_SeqOfH245VideoCapability;
...
/**************************************************************/
/*                                                            */
/*  _SeqOfH245GenericCapability                               */
/*                                                            */
/**************************************************************/

/* List of H245GenericCapability */
typedef DList H245_SeqOfH245GenericCapability;
...
typedef struct EXTERN H245ExtendedVideoCapability {
   struct {
      unsigned videoCapabilityExtensionPresent : 1;
   } m;
   H245_SeqOfH245VideoCapability videoCapability;
   H245_SeqOfH245GenericCapability videoCapabilityExtension;
...
typedef struct EXTERN H245VideoCapability {
   ...
   union {
      ...
      /* t = 7 */
      H245ExtendedVideoCapability *extendedVideoCapability;
      /* t = 8 */
   } u;
} H245VideoCapability;
...
typedef struct EXTERN H245IS11172AudioCapability {
   ...
   OOBOOL audioLayer2;
   OOBOOL audioLayer3;
   OOBOOL audioSampling32k;
   OOBOOL audioSampling44k1;
   OOBOOL audioSampling48k;
   OOBOOL singleChannel;
   OOBOOL twoChannels;
   OOUINT16 bitRate;
...
typedef struct EXTERN H245IS13818AudioCapability {
   ...
   OOBOOL audioLayer2;
   OOBOOL audioLayer3;
   OOBOOL audioSampling16k;
   OOBOOL audioSampling22k05;
   OOBOOL audioSampling24k;
   OOBOOL audioSampling32k;
   OOBOOL audioSampling44k1;
   OOBOOL audioSampling48k;
   OOBOOL singleChannel;
   OOBOOL twoChannels;
   OOBOOL threeChannels2_1;
   OOBOOL threeChannels3_0;
   OOBOOL fourChannels2_0_2_0;
   OOBOOL fourChannels2_2;
   OOBOOL fourChannels3_1;
   OOBOOL fiveChannels3_0_2_0;
   OOBOOL fiveChannels3_2;
   OOBOOL lowFrequencyEnhancement;
   OOBOOL multilingual;
   OOUINT16 bitRate;
...
typedef struct EXTERN H245G7231AnnexCCapability_g723AnnexCAudioMode {
   OOUINT8 highRateMode0;
   OOUINT8 highRateMode1;
   OOUINT8 lowRateMode0;
   OOUINT8 lowRateMode1;
   OOUINT8 sidMode0;
   OOUINT8 sidMode1;
...
typedef struct EXTERN H245NoPTAudioTelephonyEventCapability {
   const char* audioTelephoneEvent;
...
typedef struct EXTERN H245AudioCapability {
   ...
   union {
      ...
      H245NonStandardParameter *nonStandard;
      /* t = 2 */
      OOUINT16 g711Alaw64k;
      /* t = 3 */
      OOUINT16 g711Alaw56k;
      /* t = 4 */
      OOUINT16 g711Ulaw64k;
      /* t = 5 */
      OOUINT16 g711Ulaw56k;
      /* t = 6 */
      OOUINT16 g722_64k;
      /* t = 7 */
      OOUINT16 g722_56k;
      ...
      /* t = 15 */
      OOUINT16 g729wAnnexB;
      /* t = 16 */
      OOUINT16 g729AnnexAwAnnexB;
      /* t = 17 */
...
typedef struct EXTERN H245ConferenceCapability {
   ...
   OOBOOL chairControlCapability;
   OOBOOL videoIndicateMixingCapability;
   OOBOOL multipointVisualizationCapability;
...
typedef struct EXTERN H245EncryptionAuthenticationAndIntegrity {
   struct {
      ...
      unsigned genericH235SecurityCapabilityPresent : 1;
   } m;
   ...
   H245GenericCapability genericH235SecurityCapability;
...
#define T_H245UserInputCapability_encryptedBasicString 8
#define T_H245UserInputCapability_encryptedIA5String 9
#define T_H245UserInputCapability_encryptedGeneralString 10
#define T_H245UserInputCapability_secureDTMF 11
#define T_H245UserInputCapability_genericUserInputCapability 12
#define T_H245UserInputCapability_extElem1 13
...
typedef struct EXTERN H245UserInputCapability {
   ...
   union {
      ...
      /* t = 11 */
      /* t = 12 */
      H245GenericCapability *genericUserInputCapability;
      /* t = 13 */
   } u;
...
typedef struct EXTERN H245DepFECCapability_rfc2733_separateStream {
   OOBOOL separatePort;
   OOBOOL samePort;
} H245DepFECCapability_rfc2733_separateStream;
...
typedef struct EXTERN H245DepFECCapability_rfc2733 {
   OOBOOL redundancyEncoding;
   H245DepFECCapability_rfc2733_separateStream separateStream;
...
#define T_H245DepFECCapability_rfc2733  1
#define T_H245DepFECCapability_extElem1 2

typedef struct EXTERN H245DepFECCapability {
   int t;
   union {
      /* t = 1 */
      H245DepFECCapability_rfc2733 *rfc2733;
      /* t = 2 */
   } u;
...
#define T_H245FECCapability_rfc2733Format_rfc2733rfc2198 1
#define T_H245FECCapability_rfc2733Format_rfc2733sameport 2
#define T_H245FECCapability_rfc2733Format_rfc2733diffport 3

typedef struct EXTERN H245FECCapability_rfc2733Format {
   int t;
   union {
      /* t = 1 */
      H245MaxRedundancy rfc2733rfc2198;
      /* t = 2 */
      H245MaxRedundancy rfc2733sameport;
      /* t = 3 */
      H245MaxRedundancy rfc2733diffport;
   } u;
} H245FECCapability_rfc2733Format;
...
typedef struct EXTERN H245FECCapability {
   struct {
      unsigned fecSchemePresent : 1;
      unsigned rfc2733FormatPresent : 1;
   } m;
   H245CapabilityTableEntryNumber protectedCapability;
   ASN1OBJID fecScheme;
   H245FECCapability_rfc2733Format rfc2733Format;
} H245FECCapability;
...
#define T_H245Capability_depFecCapability 25
#define T_H245Capability_multiplePayloadStreamCapability 26
#define T_H245Capability_fecCapability  27
#define T_H245Capability_redundancyEncodingCap 28
#define T_H245Capability_oneOfCapabilities 29
#define T_H245Capability_extElem1       30
...
typedef struct EXTERN H245Capability {
   ...
   union {
      ...
      /* t = 11 */
      OOBOOL h233EncryptionTransmitCapability;
      /* t = 12 */
      ...
      /* t = 15 */
      OOUINT8 maxPendingReplacementFor;
      /* t = 16 */
      ...
      /* t = 25 */
      H245DepFECCapability *depFecCapability;
      /* t = 26 */
      H245MultiplePayloadStreamCapability *multiplePayloadStreamCapability;
      /* t = 27 */
      H245FECCapability *fecCapability;
      /* t = 28 */
      H245RedundancyEncodingCapability *redundancyEncodingCap;
      /* t = 29 */
      H245AlternativeCapabilitySet *oneOfCapabilities;
      /* t = 30 */
   } u;
} H245Capability;
...
/**************************************************************/
/*                                                            */
/*  _SeqOfH245GenericInformation                              */
/*                                                            */
/**************************************************************/

/* List of H245GenericInformation */
typedef DList H245_SeqOfH245GenericInformation;
...
typedef struct EXTERN H245TerminalCapabilitySet {
   struct {
      ...
      unsigned genericInformationPresent : 1;
   } m;
   ...
   H245_SeqOfH245GenericInformation genericInformation;
...
typedef struct EXTERN H245DepFECData_rfc2733_mode_separateStream_differentPort {
   struct {
      unsigned protectedPayloadTypePresent : 1;
   } m;
   OOUINT8 protectedSessionID;
   OOUINT8 protectedPayloadType;
...
typedef struct EXTERN H245DepFECData_rfc2733_mode_separateStream_samePort {
   OOUINT8 protectedPayloadType;
...
#define T_H245DepFECData_rfc2733_mode_separateStream_differentPort 1
#define T_H245DepFECData_rfc2733_mode_separateStream_samePort 2
#define T_H245DepFECData_rfc2733_mode_separateStream_extElem1 3

typedef struct EXTERN H245DepFECData_rfc2733_mode_separateStream {
   int t;
   union {
      /* t = 1 */
      H245DepFECData_rfc2733_mode_separateStream_differentPort *differentPort;
      /* t = 2 */
      H245DepFECData_rfc2733_mode_separateStream_samePort *samePort;
      /* t = 3 */
   } u;
...
#define T_H245DepFECData_rfc2733_mode_redundancyEncoding 1
#define T_H245DepFECData_rfc2733_mode_separateStream 2
#define T_H245DepFECData_rfc2733_mode_extElem1 3

typedef struct EXTERN H245DepFECData_rfc2733_mode {
   int t;
   union {
      /* t = 1 */
      /* t = 2 */
      H245DepFECData_rfc2733_mode_separateStream *separateStream;
      /* t = 3 */
   } u;
} H245DepFECData_rfc2733_mode;
...
typedef struct EXTERN H245DepFECData_rfc2733 {
   H245DepFECData_rfc2733_mode mode;
} H245DepFECData_rfc2733;
...
#define T_H245DepFECData_rfc2733        1

typedef struct EXTERN H245DepFECData {
   int t;
   union {
      /* t = 1 */
      H245DepFECData_rfc2733 *rfc2733;
   } u;
} H245DepFECData;
...
typedef struct EXTERN H245FECData_rfc2733_pktMode_rfc2733sameport {
   ASN1OCTET __dummy__;
...
typedef struct EXTERN H245FECData_rfc2733_pktMode_rfc2733diffport {
   H245LogicalChannelNumber protectedChannel;
...
#define T_H245FECData_rfc2733_pktMode_rfc2198coding 1
#define T_H245FECData_rfc2733_pktMode_rfc2733sameport 2
#define T_H245FECData_rfc2733_pktMode_rfc2733diffport 3
#define T_H245FECData_rfc2733_pktMode_extElem1 4

typedef struct EXTERN H245FECData_rfc2733_pktMode {
   int t;
   union {
      /* t = 1 */
      /* t = 2 */
      H245FECData_rfc2733_pktMode_rfc2733sameport *rfc2733sameport;
      /* t = 3 */
      H245FECData_rfc2733_pktMode_rfc2733diffport *rfc2733diffport;
      /* t = 4 */
   } u;
} H245FECData_rfc2733_pktMode;
...
typedef struct EXTERN H245FECData_rfc2733 {
   ...
   OOUINT8 protectedPayloadType;
   ASN1OBJID fecScheme;
   H245FECData_rfc2733_pktMode pktMode;
} H245FECData_rfc2733;
...
#define T_H245FECData_extElem1          2
...
#define T_H245H235Media_mediaType_depFec 7
#define T_H245H235Media_mediaType_fec   8
#define T_H245H235Media_mediaType_extElem1 9
...
#define T_H245DataType_depFec           12
#define T_H245DataType_fec              13
#define T_H245DataType_extElem1         14
...
typedef struct EXTERN H245H223LogicalChannelParameters_adaptationLayerType_al3 {
   OOUINT8 controlFieldOctets;
   OOUINT32 sendBufferSize;
...
typedef struct EXTERN H245H223AL1MParameters {
   ...
   OOUINT8 rcpcCodeRate;
   H245H223AL1MParameters_arqType arqType;
   OOBOOL alpduInterleaving;
   OOBOOL alsduSplitting;
   OOUINT8 rsCodeCorrection;
...
/* List of H245UnicastAddress_iPSourceRouteAddress_route_element */
typedef DList H245_SeqOfH245UnicastAddress_iPSourceRouteAddress_route_element;
...
typedef struct EXTERN H245H2250LogicalChannelParameters {
   ...
   OOUINT8 sessionID;
   OOUINT8 associatedSessionID;
   H245TransportAddress mediaChannel;
   OOBOOL mediaGuaranteedDelivery;
   H245TransportAddress mediaControlChannel;
   OOBOOL mediaControlGuaranteedDelivery;
   OOBOOL silenceSuppression;
...
typedef struct EXTERN H245EncryptionSync {
   struct {
      ...
      unsigned genericParameterPresent : 1;
   } m;
   H245NonStandardParameter nonStandard;
   OOUINT8 synchFlag;
   ASN1DynOctStr h235Key;
   H245EncryptionSync_escrowentry escrowentry;
   H245GenericParameter genericParameter;
} H245EncryptionSync;
...
struct EXTERN H245MultiplexElement;
...
#define T_H245FECMode_rfc2733Format_rfc2733rfc2198 1
#define T_H245FECMode_rfc2733Format_rfc2733sameport 2
#define T_H245FECMode_rfc2733Format_rfc2733diffport 3

typedef struct EXTERN H245FECMode_rfc2733Format {
   int t;
   union {
      /* t = 1 */
      H245MaxRedundancy rfc2733rfc2198;
...
typedef struct EXTERN H245FECMode {
   ...
   struct H245ModeElementType *protectedElement;
   ASN1OBJID fecScheme;
   H245FECMode_rfc2733Format rfc2733Format;
} H245FECMode;
...
#define T_H245RedundancyEncodingDTModeElement_type_fecMode 7
#define T_H245RedundancyEncodingDTModeElement_type_extElem1 8
...
typedef struct EXTERN H245DepFECMode_rfc2733Mode_mode_separateStream_differentPort {
   struct {
      unsigned protectedPayloadTypePresent : 1;
   } m;
   OOUINT8 protectedSessionID;
...
typedef struct EXTERN H245DepFECMode_rfc2733Mode_mode_separateStream_samePort {
...
#define T_H245DepFECMode_rfc2733Mode_mode_separateStream_differentPort 1
#define T_H245DepFECMode_rfc2733Mode_mode_separateStream_samePort 2
#define T_H245DepFECMode_rfc2733Mode_mode_separateStream_extElem1 3

typedef struct EXTERN H245DepFECMode_rfc2733Mode_mode_separateStream {
   int t;
   union {
      /* t = 1 */
      H245DepFECMode_rfc2733Mode_mode_separateStream_differentPort *differentPort;
      /* t = 2 */
      H245DepFECMode_rfc2733Mode_mode_separateStream_samePort *samePort;
      /* t = 3 */
   } u;
...
#define T_H245DepFECMode_rfc2733Mode_mode_redundancyEncoding 1
#define T_H245DepFECMode_rfc2733Mode_mode_separateStream 2
#define T_H245DepFECMode_rfc2733Mode_mode_extElem1 3

typedef struct EXTERN H245DepFECMode_rfc2733Mode_mode {
   int t;
   union {
      /* t = 1 */
      /* t = 2 */
      H245DepFECMode_rfc2733Mode_mode_separateStream *separateStream;
      /* t = 3 */
   } u;
} H245DepFECMode_rfc2733Mode_mode;
...
typedef struct EXTERN H245DepFECMode_rfc2733Mode {
   H245DepFECMode_rfc2733Mode_mode mode;
...
#define T_H245DepFECMode_rfc2733Mode    1
#define T_H245DepFECMode_extElem1       2

typedef struct EXTERN H245DepFECMode {
   int t;
   union {
      /* t = 1 */
      H245DepFECMode_rfc2733Mode *rfc2733Mode;
      /* t = 2 */
   } u;
} H245DepFECMode;
...
#define T_H245ModeElementType_depFecMode 10
#define T_H245ModeElementType_fecMode   11
#define T_H245ModeElementType_extElem1  12
...
typedef struct EXTERN H245ModeElement {
   struct {
      ...
      unsigned logicalChannelNumberPresent : 1;
   } m;
...
typedef struct EXTERN H245MultilinkRequest_callInformation {
   OOUINT16 maxNumberOfAdditionalConnections;
...
#define T_H245RequestMessage_genericRequest 16
#define T_H245RequestMessage_extElem1   17
...
typedef struct EXTERN H245RequestMessage {
   ...
   union {
      ...
      /* t = 16 */
      H245GenericMessage *genericRequest;
      /* t = 17 */
   } u;
} H245RequestMessage;
...
#define T_H245OpenLogicalChannelReject_cause_securityDenied 15
#define T_H245OpenLogicalChannelReject_cause_extElem1 16
...
typedef struct EXTERN H245MultilinkResponse_callInformation {
   H245DialingInformation dialingInformation;
   OOUINT32 callAssociationNumber;
...
#define T_H245ResponseMessage_genericResponse 25
#define T_H245ResponseMessage_extElem1  26
...
typedef struct EXTERN H245ResponseMessage {
   ...
   union {
      ...
      /* t = 25 */
      H245GenericMessage *genericResponse;
      /* t = 26 */
   } u;
} H245ResponseMessage;
...
#define T_H245EndSessionCommand_genericInformation 5
#define T_H245EndSessionCommand_extElem1 6
...
typedef struct EXTERN H245KeyProtectionMethod {
   OOBOOL secureChannel;
   OOBOOL sharedSecret;
   OOBOOL certProtectedKey;
...
typedef struct EXTERN H245PictureReference {
   ...
   union {
      /* t = 1 */
      OOUINT16 pictureNumber;
      /* t = 2 */
      OOUINT8 longTermPictureIndex;
      /* t = 3 */
   } u;
...
typedef struct EXTERN H245MiscellaneousCommand_type_encryptionUpdateCommand {
   struct {
      unsigned multiplePayloadStreamPresent : 1;
   } m;
   H245EncryptionSync encryptionSync;
   H245MultiplePayloadStream multiplePayloadStream;
...
typedef struct EXTERN H245MiscellaneousCommand_type_encryptionUpdateAck {
   OOUINT8 synchFlag;
...
#define T_H245MiscellaneousCommand_type_encryptionUpdateCommand 24
#define T_H245MiscellaneousCommand_type_encryptionUpdateAck 25
#define T_H245MiscellaneousCommand_type_extElem1 26
...
typedef struct EXTERN H245MiscellaneousCommand_type {
   ...
   union {
      ...
      /* t = 24 */
      H245MiscellaneousCommand_type_encryptionUpdateCommand *encryptionUpdateCommand;
      /* t = 25 */
      H245MiscellaneousCommand_type_encryptionUpdateAck *encryptionUpdateAck;
      /* t = 26 */
   } u;
...
#define T_H245EncryptionUpdateDirection_masterToSlave 1
#define T_H245EncryptionUpdateDirection_slaveToMaster 2
#define T_H245EncryptionUpdateDirection_extElem1 3

typedef struct EXTERN H245EncryptionUpdateDirection {
   int t;
} H245EncryptionUpdateDirection;
...
typedef struct EXTERN H245MiscellaneousCommand {
   ...
   H245EncryptionUpdateDirection direction;
...
typedef struct EXTERN H245NewATMVCCommand_reverseParameters {
   OOUINT16 bitRate;
   OOBOOL bitRateLockedToPCRClock;
   OOBOOL bitRateLockedToNetworkClock;
...
#define T_H245CommandMessage_genericCommand 13
#define T_H245CommandMessage_extElem1   14
...
typedef struct EXTERN H245CommandMessage {
   ...
   union {
      ...
      /* t = 13 */
      H245GenericMessage *genericCommand;
      /* t = 14 */
   } u;
} H245CommandMessage;
...
typedef struct EXTERN H245JitterIndication {
   ...
   OOUINT8 estimatedReceivedJitterMantissa;
   OOUINT8 estimatedReceivedJitterExponent;
   OOUINT8 skippedFrameCount;
   OOUINT32 additionalDecoderBuffer;
...
#define T_H245UserInputIndication_userInputSupportIndication_encryptedBasicString 5
#define T_H245UserInputIndication_userInputSupportIndication_encryptedIA5String 6
#define T_H245UserInputIndication_userInputSupportIndication_encryptedGeneralString 7
#define T_H245UserInputIndication_userInputSupportIndication_extElem1 8
...
typedef struct EXTERN H245Params {
   struct {
...
typedef struct EXTERN H245UserInputIndication_signal {
   struct {
      ...
      unsigned paramSPresent : 1;
      unsigned encryptedSignalTypePresent : 1;
   ...
   H245Params paramS;
   H245UserInputIndication_signal_encryptedSignalType encryptedSignalType;
...
/**************************************************************/
/*                                                            */
/*  UserInputIndication_extendedAlphanumeric_encryptedAlphan  */
/*                                                            */
/**************************************************************/

typedef struct EXTERN H245UserInputIndication_extendedAlphanumeric_encryptedAlphanumeric {
   struct {
      unsigned paramSPresent : 1;
   } m;
   ASN1OBJID algorithmOID;
   H245Params paramS;
   ASN1DynOctStr encrypted;
} H245UserInputIndication_extendedAlphanumeric_encryptedAlphanumeric;
...
typedef struct EXTERN H245UserInputIndication_extendedAlphanumeric {
   struct {
      unsigned rtpPayloadIndicationPresent : 1;
      unsigned encryptedAlphanumericPresent : 1;
   } m;
   const char* alphanumeric;
   H245UserInputIndication_extendedAlphanumeric_encryptedAlphanumeric encryptedAlphanumeric;
...
typedef struct EXTERN H245UserInputIndication_encryptedAlphanumeric {
   struct {
      unsigned paramSPresent : 1;
   } m;
   ASN1OBJID algorithmOID;
...
#define T_H245UserInputIndication_encryptedAlphanumeric 7
#define T_H245UserInputIndication_genericInformation 8
#define T_H245UserInputIndication_extElem1 9
...
typedef struct EXTERN H245UserInputIndication {
   ...
   union {
      ...
      /* t = 7 */
      H245UserInputIndication_encryptedAlphanumeric *encryptedAlphanumeric;
      /* t = 8 */
      H245_SeqOfH245GenericInformation *genericInformation;
      /* t = 9 */
   } u;
...
#define T_H245IndicationMessage_genericIndication 24
#define T_H245IndicationMessage_extElem1 25
...
typedef struct EXTERN H245IndicationMessage {
   ...
   union {
      ...
      /* t = 24 */
      H245GenericMessage *genericIndication;
      /* t = 25 */
   } u;
