...
/**
 * Header file for ASN.1 module H323-MESSAGES
 */
/**************************************************************/
/*                                                            */
/*  ScreeningIndicator                                        */
...
typedef OOUINT32 H225ScreeningIndicator;
...
EXTERN const char* H225ScreeningIndicator_ToString (OOINT32 value);

EXTERN int H225ScreeningIndicator_ToEnum (OOCTXT* pctxt,
...
typedef const char* H225NumberDigits;
...
typedef const char* H225TBCD_STRING;
...
typedef const char* H225IsupDigits;
...
typedef OOUINT16 H225RequestSeqNum;
...
typedef OOUINT32 H225BandWidth;
...
typedef OOUINT16 H225CallReferenceValue;
...
typedef OOUINT32 H225TimeToLive;
...
#define T_H225NatureOfAddress_unknown   1
#define T_H225NatureOfAddress_subscriberNumber 2
#define T_H225NatureOfAddress_nationalNumber 3
#define T_H225NatureOfAddress_internationalNumber 4
#define T_H225NatureOfAddress_networkSpecificNumber 5
#define T_H225NatureOfAddress_routingNumberNationalFormat 6
#define T_H225NatureOfAddress_routingNumberNetworkSpecificFormat 7
#define T_H225NatureOfAddress_routingNumberWithCalledDirectoryNumber 8
#define T_H225NatureOfAddress_extElem1  9

typedef struct EXTERN H225NatureOfAddress {
   int t;
} H225NatureOfAddress;
...
typedef struct EXTERN H225IsupPublicPartyNumber {
   H225NatureOfAddress natureOfAddress;
   H225IsupDigits address;
...
typedef struct EXTERN H225IsupPrivatePartyNumber {
   H225PrivateTypeOfNumber privateTypeOfNumber;
   H225IsupDigits address;
...
#define T_H225IsupNumber_e164Number     1
#define T_H225IsupNumber_dataPartyNumber 2
#define T_H225IsupNumber_telexPartyNumber 3
#define T_H225IsupNumber_privateNumber  4
#define T_H225IsupNumber_nationalStandardPartyNumber 5
#define T_H225IsupNumber_extElem1       6

typedef struct EXTERN H225IsupNumber {
   int t;
   union {
      /* t = 1 */
      H225IsupPublicPartyNumber *e164Number;
      /* t = 2 */
      H225IsupDigits dataPartyNumber;
      /* t = 3 */
      H225IsupDigits telexPartyNumber;
      /* t = 4 */
      H225IsupPrivatePartyNumber *privateNumber;
      /* t = 5 */
      H225IsupDigits nationalStandardPartyNumber;
      /* t = 6 */
   } u;
} H225IsupNumber;
...
#define T_H225AliasAddress_isupNumber   8
#define T_H225AliasAddress_extElem1     9
...
struct EXTERN H225EnumeratedParameter;
...
typedef struct EXTERN H225Q954Details {
   OOBOOL conferenceCalling;
   OOBOOL threePartyService;
} H225Q954Details;
...
typedef struct EXTERN H225Setup_UUIE_connectionParameters {
   ...
   OOUINT16 numberOfScnConnections;
...
typedef struct EXTERN H225CallCreditServiceControl {
   ...
   OOUINT32 callDurationLimit;
   OOBOOL enforceCallDurationLimit;
...
typedef struct EXTERN H225Setup_UUIE {
   ...
   OOBOOL mediaWaitForConnect;
   OOBOOL canOverlapSend;
   H225EndpointIdentifier endpointIdentifier;
   OOBOOL multipleCalls;
   OOBOOL maintainConnection;
...
typedef struct EXTERN H225H323_UserInformation_user_data {
   OOUINT8 protocol_discriminator;
...
typedef struct EXTERN H225CallCreditCapability {
   ...
   OOBOOL canDisplayAmountString;
   OOBOOL canEnforceDurationLimit;
...
#define T_H225RehomingModel_gatekeeperBased 1
#define T_H225RehomingModel_endpointBased 2

typedef struct EXTERN H225RehomingModel {
   int t;
} H225RehomingModel;
...
typedef struct EXTERN H225GatekeeperRequest {
   struct {
      ...
      unsigned featureSetPresent : 1;
      unsigned genericDataPresent : 1;
      unsigned supportsAssignedGKPresent : 1;
      unsigned assignedGatekeeperPresent : 1;
   } m;
   ...
   H225FeatureSet featureSet;
   H225_SeqOfH225GenericData genericData;
   OOBOOL supportsAssignedGK;
   H225AlternateGK assignedGatekeeper;
...
typedef struct EXTERN H225GatekeeperConfirm {
   struct {
      ...
      unsigned genericDataPresent : 1;
      unsigned assignedGatekeeperPresent : 1;
      unsigned rehomingModelPresent : 1;
   } m;
   H225RequestSeqNum requestSeqNum;
   H225ProtocolIdentifier protocolIdentifier;
   H225NonStandardParameter nonStandardData;
   ...
   H225_SeqOfH225GenericData genericData;
   H225AlternateGK assignedGatekeeper;
   H225RehomingModel rehomingModel;
...
typedef DList H225TransportQOS_qOSCapabilities;
...
#define T_H225TransportQOS_qOSCapabilities 4
#define T_H225TransportQOS_extElem1     5
...
typedef struct EXTERN H225TransportQOS {
   ...
   union {
      ...
      /* t = 3 */
      /* t = 4 */
      H225TransportQOS_qOSCapabilities *qOSCapabilities;
      /* t = 5 */
   } u;
} H225TransportQOS;
...
/* List of const char* */
typedef DList H225RegistrationRequest_language;
...
typedef struct EXTERN H225RegistrationRequest {
   ...
   H225RegistrationRequest_language language;
...
typedef struct EXTERN H225RegistrationConfirm_preGrantedARQ {
   ...
   OOBOOL makeCall;
   OOBOOL useGKCallSignalAddressToMakeCall;
   OOBOOL answerCall;
   OOBOOL useGKCallSignalAddressToAnswer;
   OOUINT16 irrFrequencyInCall;
...
#define T_H225RegistrationRejectReason_registerWithAssignedGK 19
#define T_H225RegistrationRejectReason_extElem1 20
...
#define T_H225UnregRequestReason_registerWithAssignedGK 7
#define T_H225UnregRequestReason_extElem1 8
...
typedef struct EXTERN H225UUIEsRequested {
   ...
   OOBOOL setup;
   OOBOOL callProceeding;
   OOBOOL connect;
   OOBOOL alerting;
   OOBOOL information;
   OOBOOL releaseComplete;
   OOBOOL facility;
   OOBOOL progress;
   OOBOOL empty;
   OOBOOL status;
   OOBOOL statusInquiry;
   OOBOOL setupAcknowledge;
   OOBOOL notify;
} H225UUIEsRequested;
...
#define T_H225AdmissionRejectReason_registerWithAssignedGK 23
#define T_H225AdmissionRejectReason_extElem1 24
...
/* List of const char* */
typedef DList H225LocationRequest_language;
...
typedef struct EXTERN H225LocationRequest {
   ...
   OOBOOL canMapSrcAlias;
   H225LocationRequest_language language;
} H225LocationRequest;
